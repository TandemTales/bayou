...
/**
 * @brief Represents the Rook piece
 * 
 * The Rook is a strong defensive piece that can move any number of squares
...
public:
     ...
     * 
     * For the Rook, this includes all squares it can move to.
     * 
     * @param board The game board
